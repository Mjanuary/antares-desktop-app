...
const buttonVariants = cva(
  "fixed bg-red-400 border border-color-theme bg-parent top-0 z-50 w-[90%] lg:w-[60%] overflow-auto right-0 bottom-0",
  {
    variants: {
      size: {
...
export const SideModal: FunctionComponent<ModalProps> = ({
  children,
  title,
  size,
  noSpacing = false,
