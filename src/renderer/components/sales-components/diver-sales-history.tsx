...
export const DiverSalesHistory: FunctionComponent<{
  parentId: string;
  saleId: string;
}> = ({ parentId, saleId }) => {
  // const { data, isLoading } = useQuery({
  //   queryKey: ["diver-sales-parent-list", parentId],
  //   queryFn: () => getDiverSaleByParentIdList(parentId),
  //   enabled: !!parentId,
          ...
          return (
            ...
            >
              <div className="flex justify-between">
                ...
                {!isCurrent && (
                  // <AppLink href={`/diver-sales/${el.id}?history=true`}>
