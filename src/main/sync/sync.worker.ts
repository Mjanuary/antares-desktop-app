  ...
  try {
    ...
    const engine = new SyncEngine({
      db: {
        ...
        markTableAsSynced: (t) => callMain("db:markTableAsSynced", t),
        markRowsAsSynced: (t, ids) => callMain("db:markRowsAsSynced", t, ids),
        addRetry: (t, p, e, tp) => callMain("db:addRetry", t, p, e, tp),
